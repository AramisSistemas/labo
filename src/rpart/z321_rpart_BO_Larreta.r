...
ksemilla_azar  <- 104183   #cambiar por la primer semilla
...
setwd( "E:\\Documents\\Maestria\\LabImplementacion" )
...
setwd( "E:\\Documents\\Maestria\\LabImplementacion\\labo\\exp\\HT3210\\")   #Establezco el Working Directory DEL EXPERIMENTO
