...
ksemilla_azar  <- 104683  #Aqui poner la propia semilla
...
setwd("E:\\Documents\\Maestria\\LabImplementacion\\labo\\exp\\HT4330\\")   #Establezco el Working Directory DEL EXPERIMENTO
